        ...
        <div class="container card-content">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="container-fluid mt-4 mb-4">
                    <form method="POST" action="{{ route('update-produk', $data->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Example: Jhon"
                                        name="nama_produk" value="{{ $data->nama_produk }}" required>
                                    @error('nama_produk')
                        ...
                        <div class="mt-4">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <a href="{{ route('produk') }}" type="submit" class="btn btn-dark btn-block">Back</a>
